...
export const INDUSTRY_TAXONOMY: IndustryDefinition[] = [
  ...
  },
  {
    ...
    name: "AI Training & Human Feedback (RLHF)",
    categoryId: "technology",
    isPopular: true,
    applicableModes: ["online"],
    aliases: [
    ...
    businessTerms: {
      queryTerms: ["ai training company", "ai data evaluation firm"],
      osmTags: [{ key: "office", value: "it" }],
      googleTypes: ["software_company"],
      yelpCategories: ["it_services"],
      foursquareCategories: ["Software Company"],
    ...
    jobTerms: {
      titles: [
        ...
        "Generative AI Content Reviewer",
        "AI Model Quality Evaluator",
      ],
      keywords: ["rlhf", "human feedback", "prompt engineering", "ai evaluation", "model rating", "instruction following"],
      category: "ai_data",
    },
  },
  {
    id: "ai_data_annotation",
    name: "Data Annotation, Computer Vision & Labeling",
    categoryId: "technology",
    isPopular: true,
    applicableModes: ["online"],
    aliases: [
    ...
    businessTerms: {
      queryTerms: ["data annotation company", "data labeling service"],
      osmTags: [{ key: "office", value: "it" }],
      googleTypes: ["software_company"],
      yelpCategories: ["it_services"],
      foursquareCategories: ["Software Company"],
    ...
    jobTerms: {
      titles: [
        "Data Annotator",
        "Image Labeling Specialist",
        "Computer Vision Annotator",
        "LiDAR Annotation Specialist",
        "Text Labeling Specialist",
        "Video Annotation Specialist",
      ],
      keywords: ["annotation", "labeling", "bounding boxes", "segmentation", "lidar", "computer vision", "classification"],
      category: "ai_data",
    },
  },
  {
    id: "search_evaluation_raters",
    name: "Search Relevance & Quality Evaluation",
    categoryId: "technology",
    isPopular: true,
    applicableModes: ["online"],
    aliases: [
    ...
    businessTerms: {
      queryTerms: ["search evaluation agency"],
      osmTags: [{ key: "office", value: "it" }],
      googleTypes: ["consultant"],
    ...
    jobTerms: {
      titles: [
        ...
        "Media Search Analyst",
        "Personalized Internet Assessor",
        "Online Task Evaluator",
      ],
      keywords: ["search rating", "search relevance", "quality guidelines", "query evaluation", "web evaluation"],
      category: "ai_data",
    },
  },
  {
    id: "ai_coding_evaluation",
    name: "AI Coding & Programming Evaluation",
    categoryId: "technology",
    isPopular: true,
    applicableModes: ["online"],
    aliases: [
      "ai coding",
      "ai coding evaluator",
      "code evaluation for ai",
      "ai code review",
      "programming model evaluation",
      "software engineering feedback ai",
    ],
    businessTerms: {
      queryTerms: ["ai coding benchmark", "ai evaluation platform"],
      osmTags: [{ key: "office", value: "it" }],
      googleTypes: ["software_company"],
      yelpCategories: ["it_services"],
      foursquareCategories: ["Software Company"],
    ...
    jobTerms: {
      titles: [
        "AI Coding Evaluator",
        "AI Software Engineering Evaluator",
        "Python AI Code Reviewer",
        "Programming Benchmark Specialist",
        "Technical AI Tutor",
      ],
      keywords: ["code review", "python", "javascript", "benchmarks", "unit tests", "code evaluation"],
      category: "ai_data",
    },
  },
  {
    id: "ai_math_reasoning",
    name: "AI Mathematics & STEM Reasoning",
    categoryId: "technology",
    isPopular: false,
    applicableModes: ["online"],
    aliases: [
      "ai mathematics evaluator",
      "ai math",
      "stem ai evaluation",
      "reasoning assessment for ai",
      "mathematical problem evaluation",
    ],
    businessTerms: {
      queryTerms: ["stem evaluation", "math reasoning ai"],
      osmTags: [{ key: "office", value: "it" }],
      googleTypes: ["consultant"],
      yelpCategories: ["businessservices"],
      foursquareCategories: ["Business Services"],
    ...
    jobTerms: {
      titles: [
        "AI Mathematics Evaluator",
        "STEM AI Specialist",
        "Mathematical Reasoning Reviewer",
        "Physics & Math Evaluator for AI",
      ],
      keywords: ["mathematics", "calculus", "linear algebra", "stem", "problem solving", "reasoning"],
      category: "ai_data",
    },
  },
  {
    id: "ai_safety_quality",
    name: "AI Safety, Quality Assurance & Red Teaming",
    categoryId: "technology",
    isPopular: false,
    applicableModes: ["online"],
    aliases: [
    ...
    businessTerms: {
      queryTerms: ["ai safety auditing", "model alignment"],
      osmTags: [{ key: "office", value: "it" }],
      googleTypes: ["software_company"],
      yelpCategories: ["it_services"],
      foursquareCategories: ["Software Company"],
    ...
    jobTerms: {
      titles: [
        ...
        "Harmful Content Classifier for AI",
        "AI Quality Assurance Analyst",
      ],
      keywords: ["ai safety", "red teaming", "bias", "harm evaluation", "guardrails", "alignment"],
      category: "ai_data",
    },
  },
  {
